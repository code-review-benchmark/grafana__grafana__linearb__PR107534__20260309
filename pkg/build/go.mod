...
require (
	...
	github.com/googleapis/gax-go/v2 v2.17.0 // indirect; @grafana/grafana-backend-group
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.61.0 // indirect; @grafana/plugins-platform-backend
	...
	golang.org/x/crypto v0.48.0 // indirect; @grafana/grafana-backend-group
	...
	golang.org/x/time v0.14.0 // indirect; @grafana/grafana-backend-group
	google.golang.org/api v0.270.0 // @grafana/grafana-backend-group
	google.golang.org/grpc v1.79.2 // indirect; @grafana/plugins-platform-backend
...
require (
	...
	google.golang.org/genproto v0.0.0-20260128011058-8636f8732409 // indirect; @grafana/grafana-backend-group
